;(function ($) {
  ...
  var fullscreen_home = function (id) {
    ...
    if (
      windowWidth >= 767 &&
      windowHeight >= paddingSection.height() + 170 * 2
    ) {
      mainSection.css({
  ...
  $(document).on('ready', function () {
    ...
    btnMask.each(function () {
      $(this).append(
        '<span class="view-all-link-mask"><span class="view-all-link-mask-text">' +
          $(this).html() +
          '</span></span>'
      )
    })
    ...
    $(window).scroll(function () {
      ...
      var contentItems = $('#container').find('.subtitle')
      var currentItem = ''
